...
module.exports =  {
  ...
  theme: {
    ...
    extend: {
      backgroundColor: {
        'ripple-primary': 'rgb(56 189 248 / 0.2)',
        'ripple-secondary': 'rgb(148 163 184 / 0.2)',
        'ripple-success': 'rgb(74 222 128 / 0.2)',
        'ripple-warning': 'rgb(251 191 36 / 0.2)',
        'ripple-danger': 'rgb(248 113 113 / 0.2)',
        'ripple-info': 'rgb(96 165 250 / 0.2)',
      },
      boxShadow: {
